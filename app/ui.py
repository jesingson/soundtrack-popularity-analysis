...
DISPLAY_LABELS = {
    ...
    "energy_variance_proxy_std": "Energy Variability",
    "danceability_mean": "Mean Danceability",
    "danceability_variance_proxy_std": "Danceability Variability",
    "instrumentalness_mean": "Mean Instrumentalness",
    "instrumentalness_variance_proxy_std": "Instrumentalness Variability",
    "happiness_mean": "Mean Happiness",
    "happiness_variance_proxy_std": "Happiness Variability",
    "tempo_mean": "Mean Tempo",
    "tempo_variance_proxy_std": "Tempo Variability",
    "tempo_range": "Tempo Range",
    "key_entropy": "Key Entropy",
    "mode_entropy": "Mode Entropy",
    "pct_instrumental_tracks": "% Instrumental Tracks",
    "pct_high_energy_tracks": "% High-Energy Tracks",
    "pct_high_happiness_tracks": "% High-Happiness Tracks",
    "top_to_total_listeners": "Top Track / Total Listeners",
    "top_to_total_playcount": "Top Track / Total Playcount",
    "top_to_album_listeners": "Top Track / Album Listeners",
    "top_to_album_playcount": "Top Track / Album Playcount",
    "album_genre_group": "Album Genre",
    "film_genre_group": "Film Genre",
    "film_year_bucket": "Film Year Bucket",
    "energy_variance_proxy_std": "Energy Variability",
    "danceability_variance_proxy_std": "Danceability Variability",
    "instrumentalness_variance_proxy_std": "Instrumentalness Variability",
    "happiness_variance_proxy_std": "Happiness Variability",
    ...
    "instrumentalness_mean": "Mean Instrumentalness",
    "tempo_mean": "Mean Tempo",
    "lfm_track_listeners": "Last.fm Track Listeners",
    "lfm_track_playcount": "Last.fm Track Playcount",
    "relative_track_position": "Relative Track Position",
    "track_position_bucket": "Track Position Bucket",
    "track_number": "Track Number",
    "track_title": "Track Title",
    "track_count_observed": "Observed Track Count",
    "max_track_number_observed": "Max Observed Track Number",
    "duration_seconds": "Duration (Seconds)",
    "key": "Key",
    "mode": "Mode",
    "camelot_number": "Camelot Number",
    "camelot_mode": "Camelot Mode",
    "loudness": "Loudness",
    "is_instrumental": "Instrumental Track",
    "is_high_energy": "High-Energy Track",
    "is_high_happiness": "High-Happiness Track",
    "is_major_mode": "Major Mode",
    "energy": "Energy",
